...
public class IdentityDatingController {
	...
	final Logger logger = LoggerFactory
			.getLogger(IdentityDatingController.class);
	...
	public String search(@RequestParam("searchtype") String searchtype,
		...
		if (searchtype.equals("id")) {
			IdentityDating entry = identityDatingService.findById(new Long(
					content));
			entries.add(entry);
			...
			entries = identityDatingService
					.findByDistance(new Integer(content));
